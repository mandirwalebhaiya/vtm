...
export const metadata = {
  title:
    "Corian Mandir Manufacturer in Gurugram | Custom Corian Temple Design",

  description:
    "Leading Corian Mandir Manufacturer in Gurugram. Premium Corian Temple Designs, CNC Jali Work, Backlit Mandirs, Home Installation and Free Consultation.",

  keywords: [
    "Corian Mandir Manufacturer in Gurugram",
    "Corian Mandir Gurugram",
    "Corian Temple Design Gurugram",
    "Corian Mandir Shop Gurugram",
    "Corian Temple Manufacturer Gurugram",
  ],
};
    ...
    <div className="container-site section-padding relative z-10">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-[#f97d08] uppercase tracking-[0.3em] text-xs mb-4">
          Gurugram's Trusted Manufacturer
        </p>
        ...
        <p className="text-[#6d5c4c] text-lg leading-relaxed max-w-3xl mx-auto">
          Looking for a premium Corian Mandir Manufacturer in Gurugram?
          We design and manufacture custom Corian Mandirs with
          modern backlighting, CNC jali work, premium Corian sheets,
          and professional installation across Gurugram, Delhi NCR.
        </p>
  ...
  <section className="py-20 bg-white">
    <div className="container-site section-padding max-w-6xl mx-auto">
      ...
      <h2 className="font-display text-3xl mb-8 text-[#1a0e00]">
        Premium Corian Mandir Design Services in Gurugram
      </h2>
      ...
      <div className="space-y-6 text-[#4a3520] leading-8">
        ...
        <p>
          As a leading Corian Mandir Manufacturer in Gurugram, we have
          successfully delivered custom mandirs for apartments,
          villas, builder floors, offices, and luxury residences
          across Gurugram and Delhi NCR. Every design is customized according to
  ...
  <section className="py-20 bg-white">
    <div className="container-site section-padding">
      ...
      <h2 className="font-display text-3xl mb-10 text-center">
        Areas We Serve Across Gurugram
      </h2>
      ...
      <div className="space-y-8">
        ...
        <div>
          <h3 className="font-semibold text-xl mb-2">
            What is the cost of a Corian Mandir in Gurugram?
          </h3>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            services across Gurugram, Delhi NCR.
          </p>
        </div>
