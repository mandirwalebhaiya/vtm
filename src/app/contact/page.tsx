              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    { icon: "📍", label: "Showroom",          value: "Ground, A-11, Timber Block, Block A, Ware Housing Scheme, Kirti Nagar, New Delhi, Delhi, 110015", href: "https://maps.google.com/maps?vet=10CAAQoqAOahcKEwjI0_bh8PuTAxUAAAAAHQAAAAAQBQ..i&pvq=Cg0vZy8xMXd4MjUzXzU0IlgKUlNocmVlIFZhaXNobm8gVGVtcGxlIHwgQ29yaWFuIE1hbmRpciBTaG9wIGtpcnRpIE5hZ2FyIHwgQ29yaWFuIFRlbXBsZSBNYW51ZmFjdHVyZXIQAhgD&lqi=&fvr=1&cs=0&um=1&ie=UTF-8&fb=1&gl=in&sa=X&ftid=0x390d0301c3332387:0xfec142e4be753d90" },
        ...
        <div className="h-64 bg-gradient-to-br from-[#fdfaf5] to-[#fff8f0] flex items-center justify-center border-t border-stone-100">
          <div className="text-center">
            ...
            <p className="font-body text-sm text-[#8a7060]">
              Ground, A-11, Timber Block, Block A, Ware Housing Scheme,<br />Kirti Nagar, New Delhi, Delhi, 110015
            </p>
            <a
