...
export const metadata: Metadata = {
  title: "Customized Corian Mandirs — Premium White Pooja Mandir | Vaishno Temple",
  description:
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-[#fff8f0] to-white">
        ...
        <div className="section-padding container-site relative z-10">
          <nav className="font-body text-xs text-[#8a7060] mb-8 flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-[#1a0e00]">Customized Corian Mandirs</span>
          </nav>

          <div className="max-w-2xl">
            <p className="font-body text-xs tracking-[0.3em] uppercase text-[#f97d08] mb-4">🤍 Corian Mandir DesignsCollection</p>
            <h1 className="font-display text-5xl md:text-6xl font-semibold text-[#1a0e00] leading-tight mb-5">
              Customized Corian Mandirs —<br />
      ...
      <section className="py-10 bg-white">
        <div className="section-padding container-site">
          <SectionHeading
            ...
            title="Customized Corian Mandir Designs"
      ...
      <section className="py-20 bg-[#fdfaf5]">
        <div className="section-padding container-site">
          <SectionHeading
            ...
            subtitle="Corian is the world's leading solid surface material — used in hospitals, airports, and luxury homes."
          />
