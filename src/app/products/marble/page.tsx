...
export const metadata: Metadata = {
  title: "Marble Mandirs — Premium White Pooja Mandir | Vaishno Temple",
  description:
    "Buy premium Marble Pooja Mandirs online. Non-porous, moisture-resistant, easy to clean. Custom sizes and designs. Free installation. vaishnotemple.in",
  alternates: { canonical: "https://vaishnotemple.in/products/marble" },
  keywords: ["marble mandir", "marble pooja mandir", "white mandir", "marble  temple"],
};
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-[#fff8f0] to-white">
        ...
        <div className="section-padding container-site relative z-10">
          <nav className="font-body text-xs text-[#8a7060] mb-8 flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-[#1a0e00]">Marble Mandirs</span>
          </nav>

          <div className="max-w-2xl">
            <p className="font-body text-xs tracking-[0.3em] uppercase text-[#f97d08] mb-4">🤍 Marble Collection</p>
            ...
            <p className="font-body text-lg text-[#4a3520] leading-relaxed mb-8">
              Marble is the material of choice for discerning homeowners who want a mandir
      ...
      <section className="py-20 bg-[#fdfaf5]">
        <div className="section-padding container-site">
          <SectionHeading
            ...
            title="Why Choose Marble?"
            subtitle="Marble is the world's leading natural stone material — used in hospitals, airports, and luxury homes."
          />
