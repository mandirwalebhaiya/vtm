...
export async function generateMetadata({
  ...
  const areaData = noidaAreas.find(
    (item) => item.slug === area
  );
  ...
  return {
    title: `Corian Mandir Manufacturer in ${areaData.name} Noida | Custom Temple Design`,
    description: `Premium Corian Mandir Manufacturer in ${areaData.name}, Noida. Custom Corian Temple Design, CNC Jali Work, LED Backlit Mandirs and Professional Installation.`,
    keywords: [
        ...
        <div className="container-site section-padding relative z-10">
          ...
          <nav className="text-sm text-[#8a7060] mb-8">
            ...
            <span className="text-[#1a0e00]">
              Corian Mandir in Noida {areaData.name}
            </span>
          </nav>
        ...
        <div className="container-site section-padding max-w-5xl">
          ...
          <div className="space-y-5 text-[#8a7060] leading-8">
            ...
            <p>
              ...
              in {areaData.name}, Noida offering premium temple
        ...
        <div className="container-site section-padding">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {products.map((product) => (
              <Link
                key={product.slug}
                href={`/corian-mandir-in-noida/${areaData.slug}/${product.slug}`}
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-5 gap-2">
                  ...
                  <h3 className="text-[#1a0e00] font-semibold text-base leading-snug group-hover:text-[#f97d08] transition-colors">
                    {product.name} in {areaData.name}, Noida
                  </h3>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {noidaAreas
              ...
              .map((item) => (
                <Link
                  key={item.slug}
                  href={`/corian-mandir-in-noida/${item.slug}`}
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-[#8a7060]">
                ...
                {areaData.name} and nearby Noida areas.
              </p>
            </div>
      ...
      <section className="py-20 bg-[#1a0e00]">
        <div className="container-site section-padding text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            ...
            Corian Mandir project in {areaData.name}, Noida.
          </p>
