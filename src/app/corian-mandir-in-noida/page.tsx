...
export const metadata = {
  title:
    "Corian Mandir Manufacturer in Noida | Custom Corian Temple Design",

  description:
    "Leading Corian Mandir Manufacturer in Noida. Premium Corian Temple Designs, CNC Jali Work, Backlit Mandirs, Home Installation and Free Consultation.",

  keywords: [
    "Corian Mandir Manufacturer in Noida",
    "Corian Mandir Noida",
    "Corian Temple Design Noida",
    "Corian Mandir Shop Noida",
    "Corian Temple Manufacturer Noida",
  ],
};
    ...
    <div className="container-site section-padding relative z-10">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-[#6d5c4c] text-lg leading-relaxed max-w-3xl mx-auto">
          Looking for a premium Corian Mandir Manufacturer in Noida?
          We design and manufacture custom Corian Mandirs with
          modern backlighting, CNC jali work, premium Corian sheets,
          and professional installation across Noida, Delhi NCR.
        </p>
  ...
  <section className="py-20 bg-white">
    <div className="container-site section-padding max-w-6xl mx-auto">
      ...
      <h2 className="font-display text-3xl mb-8 text-[#1a0e00]">
        Premium Corian Mandir Design Services in Noida
      </h2>
      ...
      <div className="space-y-6 text-[#4a3520] leading-8">
        ...
        <p>
          As a leading Corian Mandir Manufacturer in Noida, we have
          successfully delivered custom mandirs for apartments,
          villas, builder floors, offices, and luxury residences
          across Noida and Delhi NCR. Every design is customized according to
      ...
      <div className="space-y-8">
        ...
        <div>
          <h3 className="font-semibold text-xl mb-2">
            What is the cost of a Corian Mandir in Noida?
          </h3>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            services across Noida, Delhi NCR.
          </p>
        </div>
